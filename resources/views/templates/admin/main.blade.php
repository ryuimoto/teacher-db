...
<head>
    ...
    <title>{{ config('name.admin_site_title') }}</title>
    <link rel="canonical" href="https://www.wrappixel.com/templates/ample-admin-lite/" />
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('libraries/ample-admin-lite-master/plugins/images/favicon.png') }}">
    <!-- Custom CSS -->
...
<body>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item pt-2">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('admin.top') }}"
                                aria-expanded="false">
                                <i class="far fa-clock" aria-hidden="true"></i>
                                <span class="hide-menu">{{ config('name.top') }}</span>
                            </a>
                        </li>
    ...
    <script src="{{ asset('libraries/ample-admin-lite-master/js/app-style-switcher.js') }}"></script>
    <script src="{{ asset('libraries/ample-admin-lite-master/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js') }}"></script>
    <!--Wave Effects -->
    <script src="{{ asset('libraries/ample-admin-lite-master/js/waves.js') }}"></script>
    <!--Menu sidebar -->
    <script src="{{ asset('libraries/ample-admin-lite-master/js/sidebarmenu.js') }}"></script>
    <!--Custom JavaScript -->
    <script src="{{ asset('libraries/ample-admin-lite-master/js/custom.js') }}"></script>
