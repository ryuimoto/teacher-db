...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="{{ asset('libraries/ample-admin-lite-master/image/png') }}" sizes="16x16" href="{{ asset('libraries/ample-admin-lite-master/plugins/images/favicon.png') }}">
    <!-- Custom CSS -->
    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="{{ route('admin.top') }}" class="btn btn-danger btn-rounded waves-effect waves-light mb-5 text-white">Back to home</a>
            </div>
        </div>
        <!-- ============================================================== -->
        <!-- Login box.scss -->
