                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="col-md-12 border-bottom p-0">
                                    <input type="text" placeholder="{{ config("word.first_name.1").config("word.last_name.1")  }}" name="name"
                                        class="form-control p-0 border-0" value="{{ $request_for_deletion->thread_name }}">
                                </div>
                            </div>
                            <div class="form-group mb-4">
                                <label for="example-email" class="col-md-12 p-0">Details</label>
                                <div class="col-md-12 border-bottom p-0">
                                    <input type="text" name="details" placeholder="{{ config("word.details.1"), }}" class="form-control p-0 border-0" name="details" value="" id="example-email">
                                </div>
                            </div>
                            <div class="form-group mb-4">
                                <div class="col-sm-12">
